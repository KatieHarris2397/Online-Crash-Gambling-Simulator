# Nexlayer — warm-flare-online-crash-gambling-simulator

**Live:** [https://warm-flare-online-crash-gambling-simulator.nexlayer.ai](https://warm-flare-online-crash-gambling-simulator.nexlayer.ai)  

**Runtime:** docs · **Port:** 3000 · **Deploy branch:** main

---

## How this deployment works

**warm-flare-online-crash-gambling-simulator** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
```yaml
application:
  name: warm-flare-online-crash-gambling-simulator
  pods:
    - name: backend
